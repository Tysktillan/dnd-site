      ...
      <div className="flex-1 overflow-y-auto bg-slate-900">
        {selectedChapter ? (
          <div className="max-w-4xl mx-auto p-8">
            <div className="mb-6">
              <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-2">{selectedChapter.title}</h1>
            ...
            <Card className="p-4 md:p-6 lg:p-8 bg-slate-800 border-slate-700">
