...
const MAGICAL_ITEMS: MagicalItem[] = [
  {
    ...
    description: 'En liten svart kattfigur i obsidian som kan väcka liv i ett föremål i några minuter för enklare uppgifter.',
    rarity: 'uncommon',
  },
  {
    id: '2',
    name: 'Välsignad Vingpinne',
    description: 'När den planteras i jord växer den till en frodig vinranka över en natt; bär ger 1d6 temp HP.',
    rarity: 'uncommon',
  },
  {
    id: '3',
    name: 'Fionas Fingerflamma',
    description: 'En ring som låter bäraren tända eller släcka ett ljus på 30 meters avstånd. Enkelt men atmosfäriskt.',
    rarity: 'common',
  },
  {
    id: '4',
    name: 'Övervakaren',
    description: 'En liten metallkula som rullas ut och låter bäraren se genom dess "öga" i 10 minuter (som clairvoyance light).',
    rarity: 'rare',
  },
  {
    id: '5',
  ...
  },
  {
    id: '6',
    name: 'Skuggblad',
    description: 'Ett litet torkat löv som, om det hålls under tungan, dämpar fotsteg och andetag → Advantage på Stealth i 10 min.',
    rarity: 'uncommon',
  },
  {
    id: '7',
